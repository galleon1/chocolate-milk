 ...
 * Schema.
 * $Id: InventoryAdjustmentAddRsType.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
public abstract class InventoryAdjustmentAddRsType implements java.io.Serializable {
    ...
    /**
     * Field _inventoryAdjustmentRet.
     */
    private org.chocolate_milk.model.InventoryAdjustmentRet _inventoryAdjustmentRet;
    ...
    public InventoryAdjustmentAddRsType() {
        super();
    }
    ...
    /**
     * Returns the value of field 'inventoryAdjustmentRet'.
     * 
     * @return the value of field 'InventoryAdjustmentRet'.
     */
    public org.chocolate_milk.model.InventoryAdjustmentRet getInventoryAdjustmentRet(
    ) {
        return this._inventoryAdjustmentRet;
    }
    ...
    /**
     * Sets the value of field 'inventoryAdjustmentRet'.
     * 
     * @param inventoryAdjustmentRet the value of field
     * 'inventoryAdjustmentRet'.
     */
    public void setInventoryAdjustmentRet(
            final org.chocolate_milk.model.InventoryAdjustmentRet inventoryAdjustmentRet) {
        this._inventoryAdjustmentRet = inventoryAdjustmentRet;
    }
