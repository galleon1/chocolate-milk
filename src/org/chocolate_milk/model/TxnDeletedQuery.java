 ...
 * Schema.
 * $Id: TxnDeletedQuery.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */

package org.chocolate_milk.model;

/**
 * Class TxnDeletedQuery.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:00 $
 */
@SuppressWarnings("serial")
public class TxnDeletedQuery implements java.io.Serializable {
    ...
    /**
     * Field _txnDelTypeList.
     */
    private java.util.List<org.chocolate_milk.model.types.TxnDelTypeType> _txnDelTypeList;
    ...
    public TxnDeletedQuery() {
        super();
        this._txnDelTypeList = new java.util.ArrayList<org.chocolate_milk.model.types.TxnDelTypeType>();
     ...
     * given is outside the bounds of the collection
     */
    public void addTxnDelType(
            final org.chocolate_milk.model.types.TxnDelTypeType vTxnDelType)
    throws java.lang.IndexOutOfBoundsException {
        this._txnDelTypeList.add(vTxnDelType);
    }
    ...
    public void addTxnDelType(
            ...
            final org.chocolate_milk.model.types.TxnDelTypeType vTxnDelType)
    throws java.lang.IndexOutOfBoundsException {
        this._txnDelTypeList.add(index, vTxnDelType);
    }
    ...
    /**
     * Method enumerateTxnDelType.
     * 
     * @return an Enumeration over all possible elements of this
     * collection
     */
    public java.util.Enumeration<? extends org.chocolate_milk.model.types.TxnDelTypeType> enumerateTxnDelType(
    ) {
        return java.util.Collections.enumeration(this._txnDelTypeList);
    }
    ...
    /**
     * Method getTxnDelType.
     * 
     * @param index
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the
     * org.chocolate_milk.model.types.TxnDelTypeType at the given
     * index
     */
    ...
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._txnDelTypeList.size()) {
            throw new IndexOutOfBoundsException("getTxnDelType: Index value '" + index + "' not in range [0.." + (this._txnDelTypeList.size() - 1) + "]");
        }

        return (org.chocolate_milk.model.types.TxnDelTypeType) _txnDelTypeList.get(index);
    }

    /**
     * Method getTxnDelType.Returns the contents of the collection
    ...
    public org.chocolate_milk.model.types.TxnDelTypeType[] getTxnDelType(
        ...
        org.chocolate_milk.model.types.TxnDelTypeType[] array = new org.chocolate_milk.model.types.TxnDelTypeType[0];
        return (org.chocolate_milk.model.types.TxnDelTypeType[]) this._txnDelTypeList.toArray(array);
    }

    /**
     * Method getTxnDelTypeCount.
     * 
     * @return the size of this collection
     */
    public int getTxnDelTypeCount(
    ) {
        return this._txnDelTypeList.size();
    }
    ...
    /**
     * Method iterateTxnDelType.
     * 
     * @return an Iterator over all possible elements in this
     * collection
     */
    public java.util.Iterator<? extends org.chocolate_milk.model.types.TxnDelTypeType> iterateTxnDelType(
    ) {
        return this._txnDelTypeList.iterator();
    }
    ...
    /**
     */
    public void removeAllTxnDelType(
    ) {
        this._txnDelTypeList.clear();
    }
    ...
    /**
     * Method removeTxnDelType.
     * 
     * @param vTxnDelType
     * @return true if the object was removed from the collection.
     */
    public boolean removeTxnDelType(
            final org.chocolate_milk.model.types.TxnDelTypeType vTxnDelType) {
        boolean removed = _txnDelTypeList.remove(vTxnDelType);
        return removed;
    }

    /**
     * Method removeTxnDelTypeAt.
     * 
     * @param index
     * @return the element removed from the collection
     */
    public org.chocolate_milk.model.types.TxnDelTypeType removeTxnDelTypeAt(
            final int index) {
        java.lang.Object obj = this._txnDelTypeList.remove(index);
        return (org.chocolate_milk.model.types.TxnDelTypeType) obj;
    }
    ...
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._txnDelTypeList.size()) {
            throw new IndexOutOfBoundsException("setTxnDelType: Index value '" + index + "' not in range [0.." + (this._txnDelTypeList.size() - 1) + "]");
        }

        this._txnDelTypeList.set(index, vTxnDelType);
    }

    /**
     * 
     * 
     * @param vTxnDelTypeArray
     */
    public void setTxnDelType(
            final org.chocolate_milk.model.types.TxnDelTypeType[] vTxnDelTypeArray) {
        //-- copy array
        _txnDelTypeList.clear();

        for (int i = 0; i < vTxnDelTypeArray.length; i++) {
                this._txnDelTypeList.add(vTxnDelTypeArray[i]);
        }
    }
     ...
     * org.chocolate_milk.model.TxnDeletedQuery
     */
    public static org.chocolate_milk.model.TxnDeletedQuery unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.chocolate_milk.model.TxnDeletedQuery) org.exolab.castor.xml.Unmarshaller.unmarshal(org.chocolate_milk.model.TxnDeletedQuery.class, reader);
    }
