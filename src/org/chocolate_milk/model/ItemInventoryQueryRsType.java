 ...
 * Schema.
 * $Id: ItemInventoryQueryRsType.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
public abstract class ItemInventoryQueryRsType implements java.io.Serializable {
    ...
    /**
     * Field _itemInventoryRetList.
     */
    private java.util.List<org.chocolate_milk.model.ItemInventoryRet> _itemInventoryRetList;
    ...
    public ItemInventoryQueryRsType() {
        super();
        this._itemInventoryRetList = new java.util.ArrayList<org.chocolate_milk.model.ItemInventoryRet>();
    }
     ...
     * 
     * 
     * @param vItemInventoryRet
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     */
    public void addItemInventoryRet(
            final org.chocolate_milk.model.ItemInventoryRet vItemInventoryRet)
    throws java.lang.IndexOutOfBoundsException {
        this._itemInventoryRetList.add(vItemInventoryRet);
    }
    ...
    public void addItemInventoryRet(
            ...
            final org.chocolate_milk.model.ItemInventoryRet vItemInventoryRet)
    throws java.lang.IndexOutOfBoundsException {
        this._itemInventoryRetList.add(index, vItemInventoryRet);
    }
    ...
    /**
     * Method enumerateItemInventoryRet.
     * 
     * @return an Enumeration over all possible elements of this
     * collection
     */
    public java.util.Enumeration<? extends org.chocolate_milk.model.ItemInventoryRet> enumerateItemInventoryRet(
    ) {
        return java.util.Collections.enumeration(this._itemInventoryRetList);
    }

    /**
     * Method getItemInventoryRet.
     * 
     * @param index
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the
     * org.chocolate_milk.model.ItemInventoryRet at the given index
     */
    public org.chocolate_milk.model.ItemInventoryRet getItemInventoryRet(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._itemInventoryRetList.size()) {
            throw new IndexOutOfBoundsException("getItemInventoryRet: Index value '" + index + "' not in range [0.." + (this._itemInventoryRetList.size() - 1) + "]");
        }

        return (org.chocolate_milk.model.ItemInventoryRet) _itemInventoryRetList.get(index);
    }

    /**
     * Method getItemInventoryRet.Returns the contents of the
    ...
    public org.chocolate_milk.model.ItemInventoryRet[] getItemInventoryRet(
        ...
        org.chocolate_milk.model.ItemInventoryRet[] array = new org.chocolate_milk.model.ItemInventoryRet[0];
        return (org.chocolate_milk.model.ItemInventoryRet[]) this._itemInventoryRetList.toArray(array);
    }

    /**
     * Method getItemInventoryRetCount.
     * 
     * @return the size of this collection
     */
    public int getItemInventoryRetCount(
    ) {
        return this._itemInventoryRetList.size();
    }
    ...
    /**
     * Method iterateItemInventoryRet.
     * 
     * @return an Iterator over all possible elements in this
     * collection
     */
    public java.util.Iterator<? extends org.chocolate_milk.model.ItemInventoryRet> iterateItemInventoryRet(
    ) {
        return this._itemInventoryRetList.iterator();
    }

    /**
     */
    public void removeAllItemInventoryRet(
    ) {
        this._itemInventoryRetList.clear();
    }

    /**
     * Method removeItemInventoryRet.
     * 
     * @param vItemInventoryRet
     * @return true if the object was removed from the collection.
     */
    public boolean removeItemInventoryRet(
            final org.chocolate_milk.model.ItemInventoryRet vItemInventoryRet) {
        boolean removed = _itemInventoryRetList.remove(vItemInventoryRet);
        return removed;
    }

    /**
     * Method removeItemInventoryRetAt.
     * 
     * @param index
     * @return the element removed from the collection
     */
    public org.chocolate_milk.model.ItemInventoryRet removeItemInventoryRetAt(
            final int index) {
        java.lang.Object obj = this._itemInventoryRetList.remove(index);
        return (org.chocolate_milk.model.ItemInventoryRet) obj;
    }
     ...
     * given is outside the bounds of the collection
     */
    public void setItemInventoryRet(
            final int index,
            final org.chocolate_milk.model.ItemInventoryRet vItemInventoryRet)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._itemInventoryRetList.size()) {
            throw new IndexOutOfBoundsException("setItemInventoryRet: Index value '" + index + "' not in range [0.." + (this._itemInventoryRetList.size() - 1) + "]");
        }

        this._itemInventoryRetList.set(index, vItemInventoryRet);
    }

    /**
     * 
     * 
     * @param vItemInventoryRetArray
     */
    public void setItemInventoryRet(
            final org.chocolate_milk.model.ItemInventoryRet[] vItemInventoryRetArray) {
        //-- copy array
        _itemInventoryRetList.clear();

        for (int i = 0; i < vItemInventoryRetArray.length; i++) {
                this._itemInventoryRetList.add(vItemInventoryRetArray[i]);
        }
    }
