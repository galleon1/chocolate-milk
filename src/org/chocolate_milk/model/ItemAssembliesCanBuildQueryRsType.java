 ...
 * Schema.
 * $Id: ItemAssembliesCanBuildQueryRsType.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
public abstract class ItemAssembliesCanBuildQueryRsType implements java.io.Serializable {
    ...
    /**
     * Field _itemAssembliesCanBuildRet.
     */
    private org.chocolate_milk.model.ItemAssembliesCanBuildRet _itemAssembliesCanBuildRet;
    ...
    public ItemAssembliesCanBuildQueryRsType() {
        super();
    }
    ...
    /**
     * Returns the value of field 'itemAssembliesCanBuildRet'.
     * 
     * @return the value of field 'ItemAssembliesCanBuildRet'.
     */
    public org.chocolate_milk.model.ItemAssembliesCanBuildRet getItemAssembliesCanBuildRet(
    ) {
        return this._itemAssembliesCanBuildRet;
    }
    ...
    /**
     * Sets the value of field 'itemAssembliesCanBuildRet'.
     * 
     * @param itemAssembliesCanBuildRet the value of field
     * 'itemAssembliesCanBuildRet'.
     */
    public void setItemAssembliesCanBuildRet(
            final org.chocolate_milk.model.ItemAssembliesCanBuildRet itemAssembliesCanBuildRet) {
        this._itemAssembliesCanBuildRet = itemAssembliesCanBuildRet;
    }
