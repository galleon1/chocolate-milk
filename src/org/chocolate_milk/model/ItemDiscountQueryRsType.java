 ...
 * Schema.
 * $Id: ItemDiscountQueryRsType.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
public abstract class ItemDiscountQueryRsType implements java.io.Serializable {
    ...
    /**
     * Field _itemDiscountRetList.
     */
    private java.util.List<org.chocolate_milk.model.ItemDiscountRet> _itemDiscountRetList;
    ...
    public ItemDiscountQueryRsType() {
        super();
        this._itemDiscountRetList = new java.util.ArrayList<org.chocolate_milk.model.ItemDiscountRet>();
    }
     ...
     * 
     * 
     * @param vItemDiscountRet
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     */
    public void addItemDiscountRet(
            final org.chocolate_milk.model.ItemDiscountRet vItemDiscountRet)
    throws java.lang.IndexOutOfBoundsException {
        this._itemDiscountRetList.add(vItemDiscountRet);
    }
    ...
    public void addItemDiscountRet(
            ...
            final org.chocolate_milk.model.ItemDiscountRet vItemDiscountRet)
    throws java.lang.IndexOutOfBoundsException {
        this._itemDiscountRetList.add(index, vItemDiscountRet);
    }
    ...
    /**
     * Method enumerateItemDiscountRet.
     * 
     * @return an Enumeration over all possible elements of this
     * collection
     */
    public java.util.Enumeration<? extends org.chocolate_milk.model.ItemDiscountRet> enumerateItemDiscountRet(
    ) {
        return java.util.Collections.enumeration(this._itemDiscountRetList);
    }

    /**
     * Method getItemDiscountRet.
     * 
     * @param index
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the
     * org.chocolate_milk.model.ItemDiscountRet at the given index
     */
    public org.chocolate_milk.model.ItemDiscountRet getItemDiscountRet(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._itemDiscountRetList.size()) {
            throw new IndexOutOfBoundsException("getItemDiscountRet: Index value '" + index + "' not in range [0.." + (this._itemDiscountRetList.size() - 1) + "]");
        }

        return (org.chocolate_milk.model.ItemDiscountRet) _itemDiscountRetList.get(index);
    }

    /**
     * Method getItemDiscountRet.Returns the contents of the
    ...
    public org.chocolate_milk.model.ItemDiscountRet[] getItemDiscountRet(
        ...
        org.chocolate_milk.model.ItemDiscountRet[] array = new org.chocolate_milk.model.ItemDiscountRet[0];
        return (org.chocolate_milk.model.ItemDiscountRet[]) this._itemDiscountRetList.toArray(array);
    }

    /**
     * Method getItemDiscountRetCount.
     * 
     * @return the size of this collection
     */
    public int getItemDiscountRetCount(
    ) {
        return this._itemDiscountRetList.size();
    }
    ...
    /**
     * Method iterateItemDiscountRet.
     * 
     * @return an Iterator over all possible elements in this
     * collection
     */
    public java.util.Iterator<? extends org.chocolate_milk.model.ItemDiscountRet> iterateItemDiscountRet(
    ) {
        return this._itemDiscountRetList.iterator();
    }

    /**
     */
    public void removeAllItemDiscountRet(
    ) {
        this._itemDiscountRetList.clear();
    }

    /**
     * Method removeItemDiscountRet.
     * 
     * @param vItemDiscountRet
     * @return true if the object was removed from the collection.
     */
    public boolean removeItemDiscountRet(
            final org.chocolate_milk.model.ItemDiscountRet vItemDiscountRet) {
        boolean removed = _itemDiscountRetList.remove(vItemDiscountRet);
        return removed;
    }

    /**
     * Method removeItemDiscountRetAt.
     * 
     * @param index
     * @return the element removed from the collection
     */
    public org.chocolate_milk.model.ItemDiscountRet removeItemDiscountRetAt(
            final int index) {
        java.lang.Object obj = this._itemDiscountRetList.remove(index);
        return (org.chocolate_milk.model.ItemDiscountRet) obj;
    }
     ...
     * given is outside the bounds of the collection
     */
    public void setItemDiscountRet(
            final int index,
            final org.chocolate_milk.model.ItemDiscountRet vItemDiscountRet)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._itemDiscountRetList.size()) {
            throw new IndexOutOfBoundsException("setItemDiscountRet: Index value '" + index + "' not in range [0.." + (this._itemDiscountRetList.size() - 1) + "]");
        }

        this._itemDiscountRetList.set(index, vItemDiscountRet);
    }

    /**
     * 
     * 
     * @param vItemDiscountRetArray
     */
    public void setItemDiscountRet(
            final org.chocolate_milk.model.ItemDiscountRet[] vItemDiscountRetArray) {
        //-- copy array
        _itemDiscountRetList.clear();

        for (int i = 0; i < vItemDiscountRetArray.length; i++) {
                this._itemDiscountRetList.add(vItemDiscountRetArray[i]);
        }
    }
