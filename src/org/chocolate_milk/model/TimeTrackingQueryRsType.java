 ...
 * Schema.
 * $Id: TimeTrackingQueryRsType.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
public abstract class TimeTrackingQueryRsType implements java.io.Serializable {
    ...
    /**
     * Field _timeTrackingRetList.
     */
    private java.util.List<org.chocolate_milk.model.TimeTrackingRet> _timeTrackingRetList;
    ...
    public TimeTrackingQueryRsType() {
        super();
        this._timeTrackingRetList = new java.util.ArrayList<org.chocolate_milk.model.TimeTrackingRet>();
    }
     ...
     * 
     * 
     * @param vTimeTrackingRet
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     */
    public void addTimeTrackingRet(
            final org.chocolate_milk.model.TimeTrackingRet vTimeTrackingRet)
    throws java.lang.IndexOutOfBoundsException {
        this._timeTrackingRetList.add(vTimeTrackingRet);
    }
    ...
    public void addTimeTrackingRet(
            ...
            final org.chocolate_milk.model.TimeTrackingRet vTimeTrackingRet)
    throws java.lang.IndexOutOfBoundsException {
        this._timeTrackingRetList.add(index, vTimeTrackingRet);
    }
    ...
    /**
     * Method enumerateTimeTrackingRet.
     * 
     * @return an Enumeration over all possible elements of this
     * collection
     */
    public java.util.Enumeration<? extends org.chocolate_milk.model.TimeTrackingRet> enumerateTimeTrackingRet(
    ) {
        return java.util.Collections.enumeration(this._timeTrackingRetList);
    }
    ...
    /**
     * Method getTimeTrackingRet.
     * 
     * @param index
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the
     * org.chocolate_milk.model.TimeTrackingRet at the given index
     */
    public org.chocolate_milk.model.TimeTrackingRet getTimeTrackingRet(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._timeTrackingRetList.size()) {
            throw new IndexOutOfBoundsException("getTimeTrackingRet: Index value '" + index + "' not in range [0.." + (this._timeTrackingRetList.size() - 1) + "]");
        }

        return (org.chocolate_milk.model.TimeTrackingRet) _timeTrackingRetList.get(index);
    }

    /**
     * Method getTimeTrackingRet.Returns the contents of the
    ...
    public org.chocolate_milk.model.TimeTrackingRet[] getTimeTrackingRet(
        ...
        org.chocolate_milk.model.TimeTrackingRet[] array = new org.chocolate_milk.model.TimeTrackingRet[0];
        return (org.chocolate_milk.model.TimeTrackingRet[]) this._timeTrackingRetList.toArray(array);
    }

    /**
     * Method getTimeTrackingRetCount.
     * 
     * @return the size of this collection
     */
    public int getTimeTrackingRetCount(
    ) {
        return this._timeTrackingRetList.size();
    }
    ...
    /**
     * Method iterateTimeTrackingRet.
     * 
     * @return an Iterator over all possible elements in this
     * collection
     */
    public java.util.Iterator<? extends org.chocolate_milk.model.TimeTrackingRet> iterateTimeTrackingRet(
    ) {
        return this._timeTrackingRetList.iterator();
    }

    /**
     */
    public void removeAllTimeTrackingRet(
    ) {
        this._timeTrackingRetList.clear();
    }

    /**
     * Method removeTimeTrackingRet.
     * 
     * @param vTimeTrackingRet
     * @return true if the object was removed from the collection.
     */
    public boolean removeTimeTrackingRet(
            final org.chocolate_milk.model.TimeTrackingRet vTimeTrackingRet) {
        boolean removed = _timeTrackingRetList.remove(vTimeTrackingRet);
        return removed;
    }

    /**
     * Method removeTimeTrackingRetAt.
     * 
     * @param index
     * @return the element removed from the collection
     */
    public org.chocolate_milk.model.TimeTrackingRet removeTimeTrackingRetAt(
            final int index) {
        java.lang.Object obj = this._timeTrackingRetList.remove(index);
        return (org.chocolate_milk.model.TimeTrackingRet) obj;
    }
     ...
     * given is outside the bounds of the collection
     */
    public void setTimeTrackingRet(
            final int index,
            final org.chocolate_milk.model.TimeTrackingRet vTimeTrackingRet)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._timeTrackingRetList.size()) {
            throw new IndexOutOfBoundsException("setTimeTrackingRet: Index value '" + index + "' not in range [0.." + (this._timeTrackingRetList.size() - 1) + "]");
        }

        this._timeTrackingRetList.set(index, vTimeTrackingRet);
    }

    /**
     * 
     * 
     * @param vTimeTrackingRetArray
     */
    public void setTimeTrackingRet(
            final org.chocolate_milk.model.TimeTrackingRet[] vTimeTrackingRetArray) {
        //-- copy array
        _timeTrackingRetList.clear();

        for (int i = 0; i < vTimeTrackingRetArray.length; i++) {
                this._timeTrackingRetList.add(vTimeTrackingRetArray[i]);
        }
    }
