 ...
 * Schema.
 * $Id: CustomerQueryRsType.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
public abstract class CustomerQueryRsType implements java.io.Serializable {
    ...
    /**
     * Field _customerRetList.
     */
    private java.util.List<org.chocolate_milk.model.CustomerRet> _customerRetList;
    ...
    public CustomerQueryRsType() {
        super();
        this._customerRetList = new java.util.ArrayList<org.chocolate_milk.model.CustomerRet>();
    }
     ...
     */
    public void addCustomerRet(
            final org.chocolate_milk.model.CustomerRet vCustomerRet)
    throws java.lang.IndexOutOfBoundsException {
        this._customerRetList.add(vCustomerRet);
    }
    ...
    public void addCustomerRet(
            ...
            final org.chocolate_milk.model.CustomerRet vCustomerRet)
    throws java.lang.IndexOutOfBoundsException {
        this._customerRetList.add(index, vCustomerRet);
    }
    ...
    /**
     * Method enumerateCustomerRet.
     * 
     * @return an Enumeration over all possible elements of this
     * collection
     */
    public java.util.Enumeration<? extends org.chocolate_milk.model.CustomerRet> enumerateCustomerRet(
    ) {
        return java.util.Collections.enumeration(this._customerRetList);
    }

    /**
     * Method getCustomerRet.
     * 
     * @param index
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the
     * org.chocolate_milk.model.CustomerRet at the given index
     */
    public org.chocolate_milk.model.CustomerRet getCustomerRet(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._customerRetList.size()) {
            throw new IndexOutOfBoundsException("getCustomerRet: Index value '" + index + "' not in range [0.." + (this._customerRetList.size() - 1) + "]");
        }

        return (org.chocolate_milk.model.CustomerRet) _customerRetList.get(index);
    }

    /**
     * Method getCustomerRet.Returns the contents of the collection
    ...
    public org.chocolate_milk.model.CustomerRet[] getCustomerRet(
        ...
        org.chocolate_milk.model.CustomerRet[] array = new org.chocolate_milk.model.CustomerRet[0];
        return (org.chocolate_milk.model.CustomerRet[]) this._customerRetList.toArray(array);
    }

    /**
     * Method getCustomerRetCount.
     * 
     * @return the size of this collection
     */
    public int getCustomerRetCount(
    ) {
        return this._customerRetList.size();
    }
    ...
    /**
     * Method iterateCustomerRet.
     * 
     * @return an Iterator over all possible elements in this
     * collection
     */
    public java.util.Iterator<? extends org.chocolate_milk.model.CustomerRet> iterateCustomerRet(
    ) {
        return this._customerRetList.iterator();
    }

    /**
     */
    public void removeAllCustomerRet(
    ) {
        this._customerRetList.clear();
    }

    /**
     * Method removeCustomerRet.
     * 
     * @param vCustomerRet
     * @return true if the object was removed from the collection.
     */
    public boolean removeCustomerRet(
            final org.chocolate_milk.model.CustomerRet vCustomerRet) {
        boolean removed = _customerRetList.remove(vCustomerRet);
        return removed;
    }

    /**
     * Method removeCustomerRetAt.
     * 
     * @param index
     * @return the element removed from the collection
     */
    public org.chocolate_milk.model.CustomerRet removeCustomerRetAt(
            final int index) {
        java.lang.Object obj = this._customerRetList.remove(index);
        return (org.chocolate_milk.model.CustomerRet) obj;
    }
    ...
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._customerRetList.size()) {
            throw new IndexOutOfBoundsException("setCustomerRet: Index value '" + index + "' not in range [0.." + (this._customerRetList.size() - 1) + "]");
        }

        this._customerRetList.set(index, vCustomerRet);
    }

    /**
     * 
     * 
     * @param vCustomerRetArray
     */
    public void setCustomerRet(
            final org.chocolate_milk.model.CustomerRet[] vCustomerRetArray) {
        //-- copy array
        _customerRetList.clear();

        for (int i = 0; i < vCustomerRetArray.length; i++) {
                this._customerRetList.add(vCustomerRetArray[i]);
        }
    }
