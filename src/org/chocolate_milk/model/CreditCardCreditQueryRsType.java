 ...
 * Schema.
 * $Id: CreditCardCreditQueryRsType.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
public abstract class CreditCardCreditQueryRsType implements java.io.Serializable {
    ...
    /**
     * Field _creditCardCreditRetList.
     */
    private java.util.List<org.chocolate_milk.model.CreditCardCreditRet> _creditCardCreditRetList;
    ...
    public CreditCardCreditQueryRsType() {
        super();
        this._creditCardCreditRetList = new java.util.ArrayList<org.chocolate_milk.model.CreditCardCreditRet>();
    }
     ...
     * 
     * 
     * @param vCreditCardCreditRet
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     */
    public void addCreditCardCreditRet(
            final org.chocolate_milk.model.CreditCardCreditRet vCreditCardCreditRet)
    throws java.lang.IndexOutOfBoundsException {
        this._creditCardCreditRetList.add(vCreditCardCreditRet);
    }
    ...
    public void addCreditCardCreditRet(
            ...
            final org.chocolate_milk.model.CreditCardCreditRet vCreditCardCreditRet)
    throws java.lang.IndexOutOfBoundsException {
        this._creditCardCreditRetList.add(index, vCreditCardCreditRet);
    }
    ...
    /**
     * Method enumerateCreditCardCreditRet.
     * 
     * @return an Enumeration over all possible elements of this
     * collection
     */
    public java.util.Enumeration<? extends org.chocolate_milk.model.CreditCardCreditRet> enumerateCreditCardCreditRet(
    ) {
        return java.util.Collections.enumeration(this._creditCardCreditRetList);
    }

    /**
     * Method getCreditCardCreditRet.
     * 
     * @param index
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the
     * org.chocolate_milk.model.CreditCardCreditRet at the given
     * index
     */
    public org.chocolate_milk.model.CreditCardCreditRet getCreditCardCreditRet(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._creditCardCreditRetList.size()) {
            throw new IndexOutOfBoundsException("getCreditCardCreditRet: Index value '" + index + "' not in range [0.." + (this._creditCardCreditRetList.size() - 1) + "]");
        }

        return (org.chocolate_milk.model.CreditCardCreditRet) _creditCardCreditRetList.get(index);
    }

    /**
     * Method getCreditCardCreditRet.Returns the contents of the
    ...
    public org.chocolate_milk.model.CreditCardCreditRet[] getCreditCardCreditRet(
        ...
        org.chocolate_milk.model.CreditCardCreditRet[] array = new org.chocolate_milk.model.CreditCardCreditRet[0];
        return (org.chocolate_milk.model.CreditCardCreditRet[]) this._creditCardCreditRetList.toArray(array);
    }

    /**
     * Method getCreditCardCreditRetCount.
     * 
     * @return the size of this collection
     */
    public int getCreditCardCreditRetCount(
    ) {
        return this._creditCardCreditRetList.size();
    }
    ...
    /**
     * Method iterateCreditCardCreditRet.
     * 
     * @return an Iterator over all possible elements in this
     * collection
     */
    public java.util.Iterator<? extends org.chocolate_milk.model.CreditCardCreditRet> iterateCreditCardCreditRet(
    ) {
        return this._creditCardCreditRetList.iterator();
    }

    /**
     */
    public void removeAllCreditCardCreditRet(
    ) {
        this._creditCardCreditRetList.clear();
    }

    /**
     * Method removeCreditCardCreditRet.
     * 
     * @param vCreditCardCreditRet
     * @return true if the object was removed from the collection.
     */
    public boolean removeCreditCardCreditRet(
            final org.chocolate_milk.model.CreditCardCreditRet vCreditCardCreditRet) {
        boolean removed = _creditCardCreditRetList.remove(vCreditCardCreditRet);
        return removed;
    }

    /**
     * Method removeCreditCardCreditRetAt.
     * 
     * @param index
     * @return the element removed from the collection
     */
    public org.chocolate_milk.model.CreditCardCreditRet removeCreditCardCreditRetAt(
            final int index) {
        java.lang.Object obj = this._creditCardCreditRetList.remove(index);
        return (org.chocolate_milk.model.CreditCardCreditRet) obj;
    }
     ...
     * given is outside the bounds of the collection
     */
    public void setCreditCardCreditRet(
            final int index,
            final org.chocolate_milk.model.CreditCardCreditRet vCreditCardCreditRet)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._creditCardCreditRetList.size()) {
            throw new IndexOutOfBoundsException("setCreditCardCreditRet: Index value '" + index + "' not in range [0.." + (this._creditCardCreditRetList.size() - 1) + "]");
        }

        this._creditCardCreditRetList.set(index, vCreditCardCreditRet);
    }

    /**
     * 
     * 
     * @param vCreditCardCreditRetArray
     */
    public void setCreditCardCreditRet(
            final org.chocolate_milk.model.CreditCardCreditRet[] vCreditCardCreditRetArray) {
        //-- copy array
        _creditCardCreditRetList.clear();

        for (int i = 0; i < vCreditCardCreditRetArray.length; i++) {
                this._creditCardCreditRetList.add(vCreditCardCreditRetArray[i]);
        }
    }
