 ...
 * Schema.
 * $Id: ARRefundCreditCardAddRsType.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
public abstract class ARRefundCreditCardAddRsType implements java.io.Serializable {
    ...
    /**
     * Field _ARRefundCreditCardRet.
     */
    private org.chocolate_milk.model.ARRefundCreditCardRet _ARRefundCreditCardRet;
    ...
    public ARRefundCreditCardAddRsType() {
        super();
    }
    ...
    /**
     * Returns the value of field 'ARRefundCreditCardRet'.
     * 
     * @return the value of field 'ARRefundCreditCardRet'.
     */
    public org.chocolate_milk.model.ARRefundCreditCardRet getARRefundCreditCardRet(
    ) {
        return this._ARRefundCreditCardRet;
    }
    ...
    /**
     * Sets the value of field 'ARRefundCreditCardRet'.
     * 
     * @param ARRefundCreditCardRet the value of field
     * 'ARRefundCreditCardRet'.
     */
    public void setARRefundCreditCardRet(
            final org.chocolate_milk.model.ARRefundCreditCardRet ARRefundCreditCardRet) {
        this._ARRefundCreditCardRet = ARRefundCreditCardRet;
    }
