 ...
 * Schema.
 * $Id: InvoiceQueryRsType.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
public abstract class InvoiceQueryRsType implements java.io.Serializable {
    ...
    /**
     * Field _invoiceRetList.
     */
    private java.util.List<org.chocolate_milk.model.InvoiceRet> _invoiceRetList;
    ...
    public InvoiceQueryRsType() {
        super();
        this._invoiceRetList = new java.util.ArrayList<org.chocolate_milk.model.InvoiceRet>();
    }
     ...
     */
    public void addInvoiceRet(
            final org.chocolate_milk.model.InvoiceRet vInvoiceRet)
    throws java.lang.IndexOutOfBoundsException {
        this._invoiceRetList.add(vInvoiceRet);
    }
    ...
    public void addInvoiceRet(
            ...
            final org.chocolate_milk.model.InvoiceRet vInvoiceRet)
    throws java.lang.IndexOutOfBoundsException {
        this._invoiceRetList.add(index, vInvoiceRet);
    }
    ...
    /**
     * Method enumerateInvoiceRet.
     * 
     * @return an Enumeration over all possible elements of this
     * collection
     */
    public java.util.Enumeration<? extends org.chocolate_milk.model.InvoiceRet> enumerateInvoiceRet(
    ) {
        return java.util.Collections.enumeration(this._invoiceRetList);
    }

    /**
     * Method getInvoiceRet.
     * 
     * @param index
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the org.chocolate_milk.model.InvoiceRet
     * at the given index
     */
    public org.chocolate_milk.model.InvoiceRet getInvoiceRet(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._invoiceRetList.size()) {
            throw new IndexOutOfBoundsException("getInvoiceRet: Index value '" + index + "' not in range [0.." + (this._invoiceRetList.size() - 1) + "]");
        }

        return (org.chocolate_milk.model.InvoiceRet) _invoiceRetList.get(index);
    }

    /**
     * Method getInvoiceRet.Returns the contents of the collection
    ...
    public org.chocolate_milk.model.InvoiceRet[] getInvoiceRet(
        ...
        org.chocolate_milk.model.InvoiceRet[] array = new org.chocolate_milk.model.InvoiceRet[0];
        return (org.chocolate_milk.model.InvoiceRet[]) this._invoiceRetList.toArray(array);
    }

    /**
     * Method getInvoiceRetCount.
     * 
     * @return the size of this collection
     */
    public int getInvoiceRetCount(
    ) {
        return this._invoiceRetList.size();
    }
    ...
    /**
     * Method iterateInvoiceRet.
     * 
     * @return an Iterator over all possible elements in this
     * collection
     */
    public java.util.Iterator<? extends org.chocolate_milk.model.InvoiceRet> iterateInvoiceRet(
    ) {
        return this._invoiceRetList.iterator();
    }

    /**
     */
    public void removeAllInvoiceRet(
    ) {
        this._invoiceRetList.clear();
    }

    /**
     * Method removeInvoiceRet.
     * 
     * @param vInvoiceRet
     * @return true if the object was removed from the collection.
     */
    public boolean removeInvoiceRet(
            final org.chocolate_milk.model.InvoiceRet vInvoiceRet) {
        boolean removed = _invoiceRetList.remove(vInvoiceRet);
        return removed;
    }

    /**
     * Method removeInvoiceRetAt.
     * 
     * @param index
     * @return the element removed from the collection
     */
    public org.chocolate_milk.model.InvoiceRet removeInvoiceRetAt(
            final int index) {
        java.lang.Object obj = this._invoiceRetList.remove(index);
        return (org.chocolate_milk.model.InvoiceRet) obj;
    }
     ...
     * given is outside the bounds of the collection
     */
    public void setInvoiceRet(
            final int index,
            final org.chocolate_milk.model.InvoiceRet vInvoiceRet)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._invoiceRetList.size()) {
            throw new IndexOutOfBoundsException("setInvoiceRet: Index value '" + index + "' not in range [0.." + (this._invoiceRetList.size() - 1) + "]");
        }

        this._invoiceRetList.set(index, vInvoiceRet);
    }

    /**
     * 
     * 
     * @param vInvoiceRetArray
     */
    public void setInvoiceRet(
            final org.chocolate_milk.model.InvoiceRet[] vInvoiceRetArray) {
        //-- copy array
        _invoiceRetList.clear();

        for (int i = 0; i < vInvoiceRetArray.length; i++) {
                this._invoiceRetList.add(vInvoiceRetArray[i]);
        }
    }
