 ...
 * Schema.
 * $Id: VehicleMileageQueryRsType.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
public abstract class VehicleMileageQueryRsType implements java.io.Serializable {
    ...
    /**
     * Field _vehicleMileageRetList.
     */
    private java.util.List<org.chocolate_milk.model.VehicleMileageRet> _vehicleMileageRetList;
    ...
    public VehicleMileageQueryRsType() {
        super();
        this._vehicleMileageRetList = new java.util.ArrayList<org.chocolate_milk.model.VehicleMileageRet>();
    }
     ...
     * 
     * 
     * @param vVehicleMileageRet
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     */
    public void addVehicleMileageRet(
            final org.chocolate_milk.model.VehicleMileageRet vVehicleMileageRet)
    throws java.lang.IndexOutOfBoundsException {
        this._vehicleMileageRetList.add(vVehicleMileageRet);
    }
    ...
    public void addVehicleMileageRet(
            ...
            final org.chocolate_milk.model.VehicleMileageRet vVehicleMileageRet)
    throws java.lang.IndexOutOfBoundsException {
        this._vehicleMileageRetList.add(index, vVehicleMileageRet);
    }
    ...
    /**
     * Method enumerateVehicleMileageRet.
     * 
     * @return an Enumeration over all possible elements of this
     * collection
     */
    public java.util.Enumeration<? extends org.chocolate_milk.model.VehicleMileageRet> enumerateVehicleMileageRet(
    ) {
        return java.util.Collections.enumeration(this._vehicleMileageRetList);
    }
    ...
    /**
     * Method getVehicleMileageRet.
     * 
     * @param index
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the
     * org.chocolate_milk.model.VehicleMileageRet at the given index
     */
    public org.chocolate_milk.model.VehicleMileageRet getVehicleMileageRet(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._vehicleMileageRetList.size()) {
            throw new IndexOutOfBoundsException("getVehicleMileageRet: Index value '" + index + "' not in range [0.." + (this._vehicleMileageRetList.size() - 1) + "]");
        }

        return (org.chocolate_milk.model.VehicleMileageRet) _vehicleMileageRetList.get(index);
    }

    /**
     * Method getVehicleMileageRet.Returns the contents of the
    ...
    public org.chocolate_milk.model.VehicleMileageRet[] getVehicleMileageRet(
        ...
        org.chocolate_milk.model.VehicleMileageRet[] array = new org.chocolate_milk.model.VehicleMileageRet[0];
        return (org.chocolate_milk.model.VehicleMileageRet[]) this._vehicleMileageRetList.toArray(array);
    }

    /**
     * Method getVehicleMileageRetCount.
     * 
     * @return the size of this collection
     */
    public int getVehicleMileageRetCount(
    ) {
        return this._vehicleMileageRetList.size();
    }
    ...
    /**
     * Method iterateVehicleMileageRet.
     * 
     * @return an Iterator over all possible elements in this
     * collection
     */
    public java.util.Iterator<? extends org.chocolate_milk.model.VehicleMileageRet> iterateVehicleMileageRet(
    ) {
        return this._vehicleMileageRetList.iterator();
    }

    /**
     */
    public void removeAllVehicleMileageRet(
    ) {
        this._vehicleMileageRetList.clear();
    }

    /**
     * Method removeVehicleMileageRet.
     * 
     * @param vVehicleMileageRet
     * @return true if the object was removed from the collection.
     */
    public boolean removeVehicleMileageRet(
            final org.chocolate_milk.model.VehicleMileageRet vVehicleMileageRet) {
        boolean removed = _vehicleMileageRetList.remove(vVehicleMileageRet);
        return removed;
    }

    /**
     * Method removeVehicleMileageRetAt.
     * 
     * @param index
     * @return the element removed from the collection
     */
    public org.chocolate_milk.model.VehicleMileageRet removeVehicleMileageRetAt(
            final int index) {
        java.lang.Object obj = this._vehicleMileageRetList.remove(index);
        return (org.chocolate_milk.model.VehicleMileageRet) obj;
    }
     ...
     * given is outside the bounds of the collection
     */
    public void setVehicleMileageRet(
            final int index,
            final org.chocolate_milk.model.VehicleMileageRet vVehicleMileageRet)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._vehicleMileageRetList.size()) {
            throw new IndexOutOfBoundsException("setVehicleMileageRet: Index value '" + index + "' not in range [0.." + (this._vehicleMileageRetList.size() - 1) + "]");
        }

        this._vehicleMileageRetList.set(index, vVehicleMileageRet);
    }

    /**
     * 
     * 
     * @param vVehicleMileageRetArray
     */
    public void setVehicleMileageRet(
            final org.chocolate_milk.model.VehicleMileageRet[] vVehicleMileageRetArray) {
        //-- copy array
        _vehicleMileageRetList.clear();

        for (int i = 0; i < vVehicleMileageRetArray.length; i++) {
                this._vehicleMileageRetList.add(vVehicleMileageRetArray[i]);
        }
    }
