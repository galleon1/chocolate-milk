 ...
 * Schema.
 * $Id: ListEventTypeType.java,v 1.1.1.1 2010-05-04 22:06:02 ryan Exp $
 */

package org.chocolate_milk.model.types;

/**
 * Enumeration ListEventTypeType.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:02 $
 */
public enum ListEventTypeType {
     ...
     * Field enumConstants.
     */
    private static final java.util.Map<java.lang.String, ListEventTypeType> enumConstants = new java.util.HashMap<java.lang.String, ListEventTypeType>();


    static {
        for (ListEventTypeType c: ListEventTypeType.values()) {
            ListEventTypeType.enumConstants.put(c.value, c);
        }
    ...
    private ListEventTypeType(final java.lang.String value) {
        this.value = value;
    }
     ...
     */
    public static org.chocolate_milk.model.types.ListEventTypeType fromValue(
            final java.lang.String value) {
        ListEventTypeType c = ListEventTypeType.enumConstants.get(value);
        if (c != null) {
            return c;
        }
