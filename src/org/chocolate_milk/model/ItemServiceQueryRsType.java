 ...
 * Schema.
 * $Id: ItemServiceQueryRsType.java,v 1.1.1.1 2010-05-04 22:05:59 ryan Exp $
 */
...
public abstract class ItemServiceQueryRsType implements java.io.Serializable {
    ...
    /**
     * Field _itemServiceRetList.
     */
    private java.util.List<org.chocolate_milk.model.ItemServiceRet> _itemServiceRetList;
    ...
    public ItemServiceQueryRsType() {
        super();
        this._itemServiceRetList = new java.util.ArrayList<org.chocolate_milk.model.ItemServiceRet>();
    }
     ...
     * 
     * 
     * @param vItemServiceRet
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     */
    public void addItemServiceRet(
            final org.chocolate_milk.model.ItemServiceRet vItemServiceRet)
    throws java.lang.IndexOutOfBoundsException {
        this._itemServiceRetList.add(vItemServiceRet);
    }
    ...
    public void addItemServiceRet(
            ...
            final org.chocolate_milk.model.ItemServiceRet vItemServiceRet)
    throws java.lang.IndexOutOfBoundsException {
        this._itemServiceRetList.add(index, vItemServiceRet);
    }
    ...
    /**
     * Method enumerateItemServiceRet.
     * 
     * @return an Enumeration over all possible elements of this
     * collection
     */
    public java.util.Enumeration<? extends org.chocolate_milk.model.ItemServiceRet> enumerateItemServiceRet(
    ) {
        return java.util.Collections.enumeration(this._itemServiceRetList);
    }

    /**
     * Method getItemServiceRet.
     * 
     * @param index
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the
     * org.chocolate_milk.model.ItemServiceRet at the given index
     */
    public org.chocolate_milk.model.ItemServiceRet getItemServiceRet(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._itemServiceRetList.size()) {
            throw new IndexOutOfBoundsException("getItemServiceRet: Index value '" + index + "' not in range [0.." + (this._itemServiceRetList.size() - 1) + "]");
        }

        return (org.chocolate_milk.model.ItemServiceRet) _itemServiceRetList.get(index);
    }

    /**
     * Method getItemServiceRet.Returns the contents of the
    ...
    public org.chocolate_milk.model.ItemServiceRet[] getItemServiceRet(
        ...
        org.chocolate_milk.model.ItemServiceRet[] array = new org.chocolate_milk.model.ItemServiceRet[0];
        return (org.chocolate_milk.model.ItemServiceRet[]) this._itemServiceRetList.toArray(array);
    }

    /**
     * Method getItemServiceRetCount.
     * 
     * @return the size of this collection
     */
    public int getItemServiceRetCount(
    ) {
        return this._itemServiceRetList.size();
    }
    ...
    /**
     * Method iterateItemServiceRet.
     * 
     * @return an Iterator over all possible elements in this
     * collection
     */
    public java.util.Iterator<? extends org.chocolate_milk.model.ItemServiceRet> iterateItemServiceRet(
    ) {
        return this._itemServiceRetList.iterator();
    }

    /**
     */
    public void removeAllItemServiceRet(
    ) {
        this._itemServiceRetList.clear();
    }

    /**
     * Method removeItemServiceRet.
     * 
     * @param vItemServiceRet
     * @return true if the object was removed from the collection.
     */
    public boolean removeItemServiceRet(
            final org.chocolate_milk.model.ItemServiceRet vItemServiceRet) {
        boolean removed = _itemServiceRetList.remove(vItemServiceRet);
        return removed;
    }

    /**
     * Method removeItemServiceRetAt.
     * 
     * @param index
     * @return the element removed from the collection
     */
    public org.chocolate_milk.model.ItemServiceRet removeItemServiceRetAt(
            final int index) {
        java.lang.Object obj = this._itemServiceRetList.remove(index);
        return (org.chocolate_milk.model.ItemServiceRet) obj;
    }
     ...
     * given is outside the bounds of the collection
     */
    public void setItemServiceRet(
            final int index,
            final org.chocolate_milk.model.ItemServiceRet vItemServiceRet)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._itemServiceRetList.size()) {
            throw new IndexOutOfBoundsException("setItemServiceRet: Index value '" + index + "' not in range [0.." + (this._itemServiceRetList.size() - 1) + "]");
        }

        this._itemServiceRetList.set(index, vItemServiceRet);
    }

    /**
     * 
     * 
     * @param vItemServiceRetArray
     */
    public void setItemServiceRet(
            final org.chocolate_milk.model.ItemServiceRet[] vItemServiceRetArray) {
        //-- copy array
        _itemServiceRetList.clear();

        for (int i = 0; i < vItemServiceRetArray.length; i++) {
                this._itemServiceRetList.add(vItemServiceRetArray[i]);
        }
    }
