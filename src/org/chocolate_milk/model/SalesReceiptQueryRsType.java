 ...
 * Schema.
 * $Id: SalesReceiptQueryRsType.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
public abstract class SalesReceiptQueryRsType implements java.io.Serializable {
    ...
    /**
     * Field _salesReceiptRetList.
     */
    private java.util.List<org.chocolate_milk.model.SalesReceiptRet> _salesReceiptRetList;
    ...
    public SalesReceiptQueryRsType() {
        super();
        this._salesReceiptRetList = new java.util.ArrayList<org.chocolate_milk.model.SalesReceiptRet>();
    }
     ...
     * 
     * 
     * @param vSalesReceiptRet
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     */
    public void addSalesReceiptRet(
            final org.chocolate_milk.model.SalesReceiptRet vSalesReceiptRet)
    throws java.lang.IndexOutOfBoundsException {
        this._salesReceiptRetList.add(vSalesReceiptRet);
    }
    ...
    public void addSalesReceiptRet(
            ...
            final org.chocolate_milk.model.SalesReceiptRet vSalesReceiptRet)
    throws java.lang.IndexOutOfBoundsException {
        this._salesReceiptRetList.add(index, vSalesReceiptRet);
    }
    ...
    /**
     * Method enumerateSalesReceiptRet.
     * 
     * @return an Enumeration over all possible elements of this
     * collection
     */
    public java.util.Enumeration<? extends org.chocolate_milk.model.SalesReceiptRet> enumerateSalesReceiptRet(
    ) {
        return java.util.Collections.enumeration(this._salesReceiptRetList);
    }
    ...
    /**
     * Method getSalesReceiptRet.
     * 
     * @param index
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the
     * org.chocolate_milk.model.SalesReceiptRet at the given index
     */
    public org.chocolate_milk.model.SalesReceiptRet getSalesReceiptRet(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._salesReceiptRetList.size()) {
            throw new IndexOutOfBoundsException("getSalesReceiptRet: Index value '" + index + "' not in range [0.." + (this._salesReceiptRetList.size() - 1) + "]");
        }

        return (org.chocolate_milk.model.SalesReceiptRet) _salesReceiptRetList.get(index);
    }

    /**
     * Method getSalesReceiptRet.Returns the contents of the
    ...
    public org.chocolate_milk.model.SalesReceiptRet[] getSalesReceiptRet(
        ...
        org.chocolate_milk.model.SalesReceiptRet[] array = new org.chocolate_milk.model.SalesReceiptRet[0];
        return (org.chocolate_milk.model.SalesReceiptRet[]) this._salesReceiptRetList.toArray(array);
    }

    /**
     * Method getSalesReceiptRetCount.
     * 
     * @return the size of this collection
     */
    public int getSalesReceiptRetCount(
    ) {
        return this._salesReceiptRetList.size();
    }
    ...
    /**
     * Method iterateSalesReceiptRet.
     * 
     * @return an Iterator over all possible elements in this
     * collection
     */
    public java.util.Iterator<? extends org.chocolate_milk.model.SalesReceiptRet> iterateSalesReceiptRet(
    ) {
        return this._salesReceiptRetList.iterator();
    }

    /**
     */
    public void removeAllSalesReceiptRet(
    ) {
        this._salesReceiptRetList.clear();
    }

    /**
     * Method removeSalesReceiptRet.
     * 
     * @param vSalesReceiptRet
     * @return true if the object was removed from the collection.
     */
    public boolean removeSalesReceiptRet(
            final org.chocolate_milk.model.SalesReceiptRet vSalesReceiptRet) {
        boolean removed = _salesReceiptRetList.remove(vSalesReceiptRet);
        return removed;
    }

    /**
     * Method removeSalesReceiptRetAt.
     * 
     * @param index
     * @return the element removed from the collection
     */
    public org.chocolate_milk.model.SalesReceiptRet removeSalesReceiptRetAt(
            final int index) {
        java.lang.Object obj = this._salesReceiptRetList.remove(index);
        return (org.chocolate_milk.model.SalesReceiptRet) obj;
    }
     ...
     * given is outside the bounds of the collection
     */
    public void setSalesReceiptRet(
            final int index,
            final org.chocolate_milk.model.SalesReceiptRet vSalesReceiptRet)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._salesReceiptRetList.size()) {
            throw new IndexOutOfBoundsException("setSalesReceiptRet: Index value '" + index + "' not in range [0.." + (this._salesReceiptRetList.size() - 1) + "]");
        }

        this._salesReceiptRetList.set(index, vSalesReceiptRet);
    }

    /**
     * 
     * 
     * @param vSalesReceiptRetArray
     */
    public void setSalesReceiptRet(
            final org.chocolate_milk.model.SalesReceiptRet[] vSalesReceiptRetArray) {
        //-- copy array
        _salesReceiptRetList.clear();

        for (int i = 0; i < vSalesReceiptRetArray.length; i++) {
                this._salesReceiptRetList.add(vSalesReceiptRetArray[i]);
        }
    }
