 ...
 * Schema.
 * $Id: BillQueryRsType.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
public abstract class BillQueryRsType implements java.io.Serializable {
     ...
     * Field _billRetList.
     */
    private java.util.List<org.chocolate_milk.model.BillRet> _billRetList;
    ...
    public BillQueryRsType() {
        super();
        this._billRetList = new java.util.ArrayList<org.chocolate_milk.model.BillRet>();
    }
     ...
     */
    public void addBillRet(
            final org.chocolate_milk.model.BillRet vBillRet)
    throws java.lang.IndexOutOfBoundsException {
        this._billRetList.add(vBillRet);
    }
    ...
    public void addBillRet(
            ...
            final org.chocolate_milk.model.BillRet vBillRet)
    throws java.lang.IndexOutOfBoundsException {
        this._billRetList.add(index, vBillRet);
    }
    ...
    /**
     * Method enumerateBillRet.
     * 
     * @return an Enumeration over all possible elements of this
     * collection
     */
    public java.util.Enumeration<? extends org.chocolate_milk.model.BillRet> enumerateBillRet(
    ) {
        return java.util.Collections.enumeration(this._billRetList);
    }
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the org.chocolate_milk.model.BillRet at
     * the given index
     */
    public org.chocolate_milk.model.BillRet getBillRet(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._billRetList.size()) {
            throw new IndexOutOfBoundsException("getBillRet: Index value '" + index + "' not in range [0.." + (this._billRetList.size() - 1) + "]");
        }

        return (org.chocolate_milk.model.BillRet) _billRetList.get(index);
    }

    /**
     * Method getBillRet.Returns the contents of the collection in
    ...
    public org.chocolate_milk.model.BillRet[] getBillRet(
        ...
        org.chocolate_milk.model.BillRet[] array = new org.chocolate_milk.model.BillRet[0];
        return (org.chocolate_milk.model.BillRet[]) this._billRetList.toArray(array);
    }

    /**
     * Method getBillRetCount.
     * 
     * @return the size of this collection
     */
    public int getBillRetCount(
    ) {
        return this._billRetList.size();
    }
    ...
    /**
     * Method iterateBillRet.
     * 
     * @return an Iterator over all possible elements in this
     * collection
     */
    public java.util.Iterator<? extends org.chocolate_milk.model.BillRet> iterateBillRet(
    ) {
        return this._billRetList.iterator();
    }

    /**
     */
    public void removeAllBillRet(
    ) {
        this._billRetList.clear();
    }

    /**
     * Method removeBillRet.
     * 
     * @param vBillRet
     * @return true if the object was removed from the collection.
     */
    public boolean removeBillRet(
            final org.chocolate_milk.model.BillRet vBillRet) {
        boolean removed = _billRetList.remove(vBillRet);
        return removed;
    }

    /**
     * Method removeBillRetAt.
     * 
     * @param index
     * @return the element removed from the collection
     */
    public org.chocolate_milk.model.BillRet removeBillRetAt(
            final int index) {
        java.lang.Object obj = this._billRetList.remove(index);
        return (org.chocolate_milk.model.BillRet) obj;
    }
     ...
     * given is outside the bounds of the collection
     */
    public void setBillRet(
            final int index,
            final org.chocolate_milk.model.BillRet vBillRet)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._billRetList.size()) {
            throw new IndexOutOfBoundsException("setBillRet: Index value '" + index + "' not in range [0.." + (this._billRetList.size() - 1) + "]");
        }

        this._billRetList.set(index, vBillRet);
    }
     ...
     */
    public void setBillRet(
            final org.chocolate_milk.model.BillRet[] vBillRetArray) {
        //-- copy array
        _billRetList.clear();

        for (int i = 0; i < vBillRetArray.length; i++) {
                this._billRetList.add(vBillRetArray[i]);
        }
    }
