 ...
 * Schema.
 * $Id: ItemServiceModDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.ItemServiceMod;

/**
 * Class ItemServiceModDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class ItemServiceModDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ItemServiceModDescriptor() {
        super();
        _xmlName = "ItemServiceMod";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ItemServiceMod target = (ItemServiceMod) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _itemServiceModChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.ItemServiceModChoice.class, "_itemServiceModChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ItemServiceMod target = (ItemServiceMod) object;
                return target.getItemServiceModChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ItemServiceMod target = (ItemServiceMod) object;
                    target.setItemServiceModChoice( (org.chocolate_milk.model.ItemServiceModChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.ItemServiceModChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.ItemServiceModChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.ItemServiceModChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _itemServiceModChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.ItemServiceMod.class;
    }
