 ...
 * Schema.
 * $Id: AccountModDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.AccountMod;

/**
 * Class AccountModDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class AccountModDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public AccountModDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                AccountMod target = (AccountMod) object;
        ...
        desc.setImmutable(true);
        desc.setSchemaType("AccountTypeType");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.AccountMod.class;
    }
