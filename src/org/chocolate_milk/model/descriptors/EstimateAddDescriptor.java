 ...
 * Schema.
 * $Id: EstimateAddDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.EstimateAdd;

/**
 * Class EstimateAddDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class EstimateAddDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public EstimateAddDescriptor() {
        super();
        _xmlName = "EstimateAdd";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                EstimateAdd target = (EstimateAdd) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _estimateAddChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.EstimateAddChoice.class, "_estimateAddChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                EstimateAdd target = (EstimateAdd) object;
                return target.getEstimateAddChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    EstimateAdd target = (EstimateAdd) object;
                    target.setEstimateAddChoice( (org.chocolate_milk.model.EstimateAddChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.EstimateAddChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.EstimateAddChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.EstimateAddChoiceDescriptor());
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _estimateAddChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.EstimateAdd.class;
    }
