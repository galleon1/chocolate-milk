 ...
 * Schema.
 * $Id: DepositModDescriptor.java,v 1.1.1.1 2010-05-04 22:06:02 ryan Exp $
 */
...
import org.chocolate_milk.model.DepositMod;

/**
 * Class DepositModDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:02 $
 */
public class DepositModDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DepositModDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                DepositMod target = (DepositMod) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _cashBackInfoMod
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.CashBackInfoMod.class, "_cashBackInfoMod", "CashBackInfoMod", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                DepositMod target = (DepositMod) object;
                return target.getCashBackInfoMod();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    DepositMod target = (DepositMod) object;
                    target.setCashBackInfoMod( (org.chocolate_milk.model.CashBackInfoMod) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setSchemaType("org.chocolate_milk.model.CashBackInfoMod");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _cashBackInfoMod
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
        ...
        desc.setValidator(fieldValidator);
        //-- _depositLineModList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.DepositLineMod.class, "_depositLineModList", "DepositLineMod", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                DepositMod target = (DepositMod) object;
                return target.getDepositLineMod();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    DepositMod target = (DepositMod) object;
                    target.addDepositLineMod( (org.chocolate_milk.model.DepositLineMod) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            public void resetValue(Object object) throws IllegalStateException, IllegalArgumentException {
                try {
                    DepositMod target = (DepositMod) object;
                    target.removeAllDepositLineMod();
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setComponentType("org.chocolate_milk.model.DepositLineMod");
        desc.setHandler(handler);
        desc.setMultivalued(true);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _depositLineModList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.DepositMod.class;
    }
