 ...
 * Schema.
 * $Id: VendorCreditModDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.VendorCreditMod;

/**
 * Class VendorCreditModDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class VendorCreditModDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public VendorCreditModDescriptor() {
        super();
        _xmlName = "VendorCreditMod";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                VendorCreditMod target = (VendorCreditMod) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _vendorCreditModChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.VendorCreditModChoice.class, "_vendorCreditModChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                VendorCreditMod target = (VendorCreditMod) object;
                return target.getVendorCreditModChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    VendorCreditMod target = (VendorCreditMod) object;
                    target.setVendorCreditModChoice( (org.chocolate_milk.model.VendorCreditModChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.VendorCreditModChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.VendorCreditModChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.VendorCreditModChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _vendorCreditModChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.VendorCreditMod.class;
    }
