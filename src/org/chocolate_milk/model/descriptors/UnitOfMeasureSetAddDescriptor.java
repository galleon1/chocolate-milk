 ...
 * Schema.
 * $Id: UnitOfMeasureSetAddDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.UnitOfMeasureSetAdd;

/**
 * Class UnitOfMeasureSetAddDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class UnitOfMeasureSetAddDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public UnitOfMeasureSetAddDescriptor() {
        super();
        _xmlName = "UnitOfMeasureSetAdd";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                UnitOfMeasureSetAdd target = (UnitOfMeasureSetAdd) object;
        ...
        desc.setImmutable(true);
        desc.setSchemaType("org.chocolate_milk.model.types.UnitOfMeasureTypeType");
        desc.setHandler(handler);
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.UnitOfMeasureSetAdd.class;
    }
