 ...
 * Schema.
 * $Id: InvoiceModDescriptor.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
import org.chocolate_milk.model.InvoiceMod;

/**
 * Class InvoiceModDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:00 $
 */
public class InvoiceModDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public InvoiceModDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                InvoiceMod target = (InvoiceMod) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _invoiceModChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.InvoiceModChoice.class, "_invoiceModChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                InvoiceMod target = (InvoiceMod) object;
                return target.getInvoiceModChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    InvoiceMod target = (InvoiceMod) object;
                    target.setInvoiceModChoice( (org.chocolate_milk.model.InvoiceModChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.InvoiceModChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.InvoiceModChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.InvoiceModChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _invoiceModChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.InvoiceMod.class;
    }
