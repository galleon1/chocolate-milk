 ...
 * Schema.
 * $Id: UIEventSubscriptionRetDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.UIEventSubscriptionRet;

/**
 * Class UIEventSubscriptionRetDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class UIEventSubscriptionRetDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public UIEventSubscriptionRetDescriptor() {
        super();
        _xmlName = "UIEventSubscriptionRet";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                UIEventSubscriptionRet target = (UIEventSubscriptionRet) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _timeLastProcessed
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_timeLastProcessed", "TimeLastProcessed", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
            ...
            {
                UIEventSubscriptionRet target = (UIEventSubscriptionRet) object;
                return target.getTimeLastProcessed();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    UIEventSubscriptionRet target = (UIEventSubscriptionRet) object;
                    target.setTimeLastProcessed( (java.lang.String) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        //-- validation code for: _timeLastProcessed
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
            org.exolab.castor.xml.validators.StringValidator typeValidator;
            typeValidator = new org.exolab.castor.xml.validators.StringValidator();
        ...
        desc.setImmutable(true);
        desc.setSchemaType("DeliveryPolicyType");
        desc.setHandler(handler);
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        desc.setValidator(fieldValidator);
        //-- _companyFileEventSubscription
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.CompanyFileEventSubscription.class, "_companyFileEventSubscription", "CompanyFileEventSubscription", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                UIEventSubscriptionRet target = (UIEventSubscriptionRet) object;
                return target.getCompanyFileEventSubscription();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    UIEventSubscriptionRet target = (UIEventSubscriptionRet) object;
                    target.setCompanyFileEventSubscription( (org.chocolate_milk.model.CompanyFileEventSubscription) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setSchemaType("org.chocolate_milk.model.CompanyFileEventSubscription");
        desc.setHandler(handler);
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        //-- validation code for: _companyFileEventSubscription
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.UIEventSubscriptionRet.class;
    }
