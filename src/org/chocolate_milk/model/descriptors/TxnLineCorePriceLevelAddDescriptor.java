 ...
 * Schema.
 * $Id: TxnLineCorePriceLevelAddDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.TxnLineCorePriceLevelAdd;

/**
 * Class TxnLineCorePriceLevelAddDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class TxnLineCorePriceLevelAddDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TxnLineCorePriceLevelAddDescriptor() {
        super();
        _xmlName = "TxnLineCorePriceLevelAdd";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                TxnLineCorePriceLevelAdd target = (TxnLineCorePriceLevelAdd) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _txnLineCorePriceLevelAddChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.TxnLineCorePriceLevelAddChoice.class, "_txnLineCorePriceLevelAddChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                TxnLineCorePriceLevelAdd target = (TxnLineCorePriceLevelAdd) object;
                return target.getTxnLineCorePriceLevelAddChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    TxnLineCorePriceLevelAdd target = (TxnLineCorePriceLevelAdd) object;
                    target.setTxnLineCorePriceLevelAddChoice( (org.chocolate_milk.model.TxnLineCorePriceLevelAddChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.TxnLineCorePriceLevelAddChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.TxnLineCorePriceLevelAddChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.TxnLineCorePriceLevelAddChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _txnLineCorePriceLevelAddChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.TxnLineCorePriceLevelAdd.class;
    }
