 ...
 * Schema.
 * $Id: ItemSubtotalRetDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.ItemSubtotalRet;

/**
 * Class ItemSubtotalRetDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class ItemSubtotalRetDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ItemSubtotalRetDescriptor() {
        super();
        _xmlName = "ItemSubtotalRet";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ItemSubtotalRet target = (ItemSubtotalRet) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _specialItemType
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.types.SpecialItemTypeType.class, "_specialItemType", "SpecialItemType", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ItemSubtotalRet target = (ItemSubtotalRet) object;
                return target.getSpecialItemType();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ItemSubtotalRet target = (ItemSubtotalRet) object;
                    target.setSpecialItemType( (org.chocolate_milk.model.types.SpecialItemTypeType) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(org.chocolate_milk.model.types.SpecialItemTypeType.class, handler);
        desc.setImmutable(true);
        desc.setSchemaType("SpecialItemTypeType");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _specialItemType
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.ItemSubtotalRet.class;
    }
