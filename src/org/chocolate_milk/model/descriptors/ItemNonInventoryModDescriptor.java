 ...
 * Schema.
 * $Id: ItemNonInventoryModDescriptor.java,v 1.1.1.1 2010-05-04 22:06:02 ryan Exp $
 */
...
import org.chocolate_milk.model.ItemNonInventoryMod;

/**
 * Class ItemNonInventoryModDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:02 $
 */
public class ItemNonInventoryModDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ItemNonInventoryModDescriptor() {
        super();
        _xmlName = "ItemNonInventoryMod";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ItemNonInventoryMod target = (ItemNonInventoryMod) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _itemNonInventoryModChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.ItemNonInventoryModChoice.class, "_itemNonInventoryModChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ItemNonInventoryMod target = (ItemNonInventoryMod) object;
                return target.getItemNonInventoryModChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ItemNonInventoryMod target = (ItemNonInventoryMod) object;
                    target.setItemNonInventoryModChoice( (org.chocolate_milk.model.ItemNonInventoryModChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.ItemNonInventoryModChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.ItemNonInventoryModChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.ItemNonInventoryModChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _itemNonInventoryModChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.ItemNonInventoryMod.class;
    }
