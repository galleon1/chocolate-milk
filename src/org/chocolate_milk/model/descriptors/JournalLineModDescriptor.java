 ...
 * Schema.
 * $Id: JournalLineModDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.JournalLineMod;

/**
 * Class JournalLineModDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class JournalLineModDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public JournalLineModDescriptor() {
        super();
        _xmlName = "JournalLineMod";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                JournalLineMod target = (JournalLineMod) object;
        ...
        //-- _journalLineType
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.types.JournalLineTypeType.class, "_journalLineType", "JournalLineType", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                JournalLineMod target = (JournalLineMod) object;
                return target.getJournalLineType();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    JournalLineMod target = (JournalLineMod) object;
                    target.setJournalLineType( (org.chocolate_milk.model.types.JournalLineTypeType) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(org.chocolate_milk.model.types.JournalLineTypeType.class, handler);
        desc.setImmutable(true);
        desc.setSchemaType("org.chocolate_milk.model.types.JournalLineTypeType");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _journalLineType
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.JournalLineMod.class;
    }
