 ...
 * Schema.
 * $Id: CustomerMsgListRefDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.CustomerMsgListRef;

/**
 * Class CustomerMsgListRefDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class CustomerMsgListRefDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CustomerMsgListRefDescriptor() {
        super();
        _xmlName = "CustomerMsgListRef";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CustomerMsgListRef target = (CustomerMsgListRef) object;
        ...
        { //-- local scope
            ...
            fieldValidator.setValidator(typeValidator);
            typeValidator.setWhiteSpace("preserve");
            typeValidator.setMaxLength(101);
        }
        desc.setValidator(fieldValidator);
    }
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.CustomerMsgListRef.class;
    }
