 ...
 * Schema.
 * $Id: ItemNonInventoryRetDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.ItemNonInventoryRet;

/**
 * Class ItemNonInventoryRetDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class ItemNonInventoryRetDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ItemNonInventoryRetDescriptor() {
        super();
        _xmlName = "ItemNonInventoryRet";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ItemNonInventoryRet target = (ItemNonInventoryRet) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _itemNonInventoryRetChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.ItemNonInventoryRetChoice.class, "_itemNonInventoryRetChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ItemNonInventoryRet target = (ItemNonInventoryRet) object;
                return target.getItemNonInventoryRetChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ItemNonInventoryRet target = (ItemNonInventoryRet) object;
                    target.setItemNonInventoryRetChoice( (org.chocolate_milk.model.ItemNonInventoryRetChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.ItemNonInventoryRetChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.ItemNonInventoryRetChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.ItemNonInventoryRetChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _itemNonInventoryRetChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.ItemNonInventoryRet.class;
    }
