 ...
 * Schema.
 * $Id: EstimateRetDescriptor.java,v 1.1.1.1 2010-05-04 22:06:02 ryan Exp $
 */
...
import org.chocolate_milk.model.EstimateRet;

/**
 * Class EstimateRetDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:02 $
 */
public class EstimateRetDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public EstimateRetDescriptor() {
        super();
        _xmlName = "EstimateRet";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                EstimateRet target = (EstimateRet) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _estimateRetChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.EstimateRetChoice.class, "_estimateRetChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                EstimateRet target = (EstimateRet) object;
                return target.getEstimateRetChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    EstimateRet target = (EstimateRet) object;
                    target.setEstimateRetChoice( (org.chocolate_milk.model.EstimateRetChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.EstimateRetChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.EstimateRetChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.EstimateRetChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _estimateRetChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.EstimateRet.class;
    }
