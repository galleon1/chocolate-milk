 ...
 * Schema.
 * $Id: ComponentItemLineRetDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.ComponentItemLineRet;

/**
 * Class ComponentItemLineRetDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class ComponentItemLineRetDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ComponentItemLineRetDescriptor() {
        super();
        _xmlName = "ComponentItemLineRet";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ComponentItemLineRet target = (ComponentItemLineRet) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _quantityNeeded
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_quantityNeeded", "QuantityNeeded", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
            ...
            {
                ComponentItemLineRet target = (ComponentItemLineRet) object;
                return target.getQuantityNeeded();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ComponentItemLineRet target = (ComponentItemLineRet) object;
                    target.setQuantityNeeded( (java.lang.String) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        //-- validation code for: _quantityNeeded
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
            org.exolab.castor.xml.validators.StringValidator typeValidator;
            typeValidator = new org.exolab.castor.xml.validators.StringValidator();
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.ComponentItemLineRet.class;
    }
