 ...
 * Schema.
 * $Id: ReceivePaymentModDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.ReceivePaymentMod;

/**
 * Class ReceivePaymentModDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class ReceivePaymentModDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ReceivePaymentModDescriptor() {
        super();
        _xmlName = "ReceivePaymentMod";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ReceivePaymentMod target = (ReceivePaymentMod) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _creditCardTxnInfoMod
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.CreditCardTxnInfoMod.class, "_creditCardTxnInfoMod", "CreditCardTxnInfoMod", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ReceivePaymentMod target = (ReceivePaymentMod) object;
                return target.getCreditCardTxnInfoMod();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ReceivePaymentMod target = (ReceivePaymentMod) object;
                    target.setCreditCardTxnInfoMod( (org.chocolate_milk.model.CreditCardTxnInfoMod) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setSchemaType("org.chocolate_milk.model.CreditCardTxnInfoMod");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _creditCardTxnInfoMod
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.ReceivePaymentMod.class;
    }
