 ...
 * Schema.
 * $Id: ItemInventoryAssemblyModDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.ItemInventoryAssemblyMod;

/**
 * Class ItemInventoryAssemblyModDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class ItemInventoryAssemblyModDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ItemInventoryAssemblyModDescriptor() {
        super();
        _xmlName = "ItemInventoryAssemblyMod";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ItemInventoryAssemblyMod target = (ItemInventoryAssemblyMod) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _itemInventoryAssemblyModChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.ItemInventoryAssemblyModChoice.class, "_itemInventoryAssemblyModChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ItemInventoryAssemblyMod target = (ItemInventoryAssemblyMod) object;
                return target.getItemInventoryAssemblyModChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ItemInventoryAssemblyMod target = (ItemInventoryAssemblyMod) object;
                    target.setItemInventoryAssemblyModChoice( (org.chocolate_milk.model.ItemInventoryAssemblyModChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.ItemInventoryAssemblyModChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.ItemInventoryAssemblyModChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.ItemInventoryAssemblyModChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _itemInventoryAssemblyModChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.ItemInventoryAssemblyMod.class;
    }
