 ...
 * Schema.
 * $Id: JournalEntryModDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.JournalEntryMod;

/**
 * Class JournalEntryModDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class JournalEntryModDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public JournalEntryModDescriptor() {
        super();
        _xmlName = "JournalEntryMod";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                JournalEntryMod target = (JournalEntryMod) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _journalLineModList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.JournalLineMod.class, "_journalLineModList", "JournalLineMod", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                JournalEntryMod target = (JournalEntryMod) object;
                return target.getJournalLineMod();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    JournalEntryMod target = (JournalEntryMod) object;
                    target.addJournalLineMod( (org.chocolate_milk.model.JournalLineMod) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            public void resetValue(Object object) throws IllegalStateException, IllegalArgumentException {
                try {
                    JournalEntryMod target = (JournalEntryMod) object;
                    target.removeAllJournalLineMod();
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setComponentType("org.chocolate_milk.model.JournalLineMod");
        desc.setHandler(handler);
        desc.setMultivalued(true);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _journalLineModList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.JournalEntryMod.class;
    }
