 ...
 * Schema.
 * $Id: BillPaymentCheckModDescriptor.java,v 1.1.1.1 2010-05-04 22:06:02 ryan Exp $
 */
...
import org.chocolate_milk.model.BillPaymentCheckMod;

/**
 * Class BillPaymentCheckModDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:02 $
 */
public class BillPaymentCheckModDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public BillPaymentCheckModDescriptor() {
        super();
        _xmlName = "BillPaymentCheckMod";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                BillPaymentCheckMod target = (BillPaymentCheckMod) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _billPaymentCheckModChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.BillPaymentCheckModChoice.class, "_billPaymentCheckModChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                BillPaymentCheckMod target = (BillPaymentCheckMod) object;
                return target.getBillPaymentCheckModChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    BillPaymentCheckMod target = (BillPaymentCheckMod) object;
                    target.setBillPaymentCheckModChoice( (org.chocolate_milk.model.BillPaymentCheckModChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.BillPaymentCheckModChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.BillPaymentCheckModChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.BillPaymentCheckModChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _billPaymentCheckModChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
        ...
        desc.setValidator(fieldValidator);
        //-- _appliedToTxnModList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.AppliedToTxnMod.class, "_appliedToTxnModList", "AppliedToTxnMod", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                BillPaymentCheckMod target = (BillPaymentCheckMod) object;
                return target.getAppliedToTxnMod();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    BillPaymentCheckMod target = (BillPaymentCheckMod) object;
                    target.addAppliedToTxnMod( (org.chocolate_milk.model.AppliedToTxnMod) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            public void resetValue(Object object) throws IllegalStateException, IllegalArgumentException {
                try {
                    BillPaymentCheckMod target = (BillPaymentCheckMod) object;
                    target.removeAllAppliedToTxnMod();
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setComponentType("org.chocolate_milk.model.AppliedToTxnMod");
        desc.setHandler(handler);
        desc.setMultivalued(true);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _appliedToTxnModList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.BillPaymentCheckMod.class;
    }
