 ...
 * Schema.
 * $Id: ItemReceiptRetDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
/**
 * Class ItemReceiptRetDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class ItemReceiptRetDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ItemReceiptRetDescriptor() {
        super();
        _xmlName = "ItemReceiptRet";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ItemReceiptRet target = (ItemReceiptRet) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _itemReceiptRetChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.ItemReceiptRetChoice.class, "_itemReceiptRetChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ItemReceiptRet target = (ItemReceiptRet) object;
                return target.getItemReceiptRetChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ItemReceiptRet target = (ItemReceiptRet) object;
                    target.setItemReceiptRetChoice( (org.chocolate_milk.model.ItemReceiptRetChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.ItemReceiptRetChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.ItemReceiptRetChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.ItemReceiptRetChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _itemReceiptRetChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.ItemReceiptRet.class;
    }
