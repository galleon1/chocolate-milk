 ...
 * Schema.
 * $Id: CreditCardTxnResultInfoDescriptor.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
import org.chocolate_milk.model.CreditCardTxnResultInfo;

/**
 * Class CreditCardTxnResultInfoDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:00 $
 */
public class CreditCardTxnResultInfoDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CreditCardTxnResultInfoDescriptor() {
        super();
        _xmlName = "CreditCardTxnResultInfo";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CreditCardTxnResultInfo target = (CreditCardTxnResultInfo) object;
        ...
        desc.setImmutable(true);
        desc.setSchemaType("org.chocolate_milk.model.types.AVSStreetType");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);
        ...
        desc.setImmutable(true);
        desc.setSchemaType("org.chocolate_milk.model.types.AVSZipType");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);
        ...
        desc.setImmutable(true);
        desc.setSchemaType("org.chocolate_milk.model.types.CardSecurityCodeMatchType");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.CreditCardTxnResultInfo.class;
    }
