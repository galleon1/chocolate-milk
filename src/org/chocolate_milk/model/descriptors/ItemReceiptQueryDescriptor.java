 ...
 * Schema.
 * $Id: ItemReceiptQueryDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.ItemReceiptQuery;

/**
 * Class ItemReceiptQueryDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class ItemReceiptQueryDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ItemReceiptQueryDescriptor() {
        super();
        _xmlName = "ItemReceiptQuery";
        ...
        //-- _itemReceiptQueryChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.ItemReceiptQueryChoice.class, "_itemReceiptQueryChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ItemReceiptQuery target = (ItemReceiptQuery) object;
                return target.getItemReceiptQueryChoice();
            }
            @Override
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ItemReceiptQuery target = (ItemReceiptQuery) object;
                    target.setItemReceiptQueryChoice( (org.chocolate_milk.model.ItemReceiptQueryChoice) value);
            ...
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.ItemReceiptQueryChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.ItemReceiptQueryChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.ItemReceiptQueryChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _itemReceiptQueryChoice
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.ItemReceiptQuery.class;
    }
