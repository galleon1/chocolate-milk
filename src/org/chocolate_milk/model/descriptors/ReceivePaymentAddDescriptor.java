 ...
 * Schema.
 * $Id: ReceivePaymentAddDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.ReceivePaymentAdd;

/**
 * Class ReceivePaymentAddDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class ReceivePaymentAddDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ReceivePaymentAddDescriptor() {
        super();
        _xmlName = "ReceivePaymentAdd";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ReceivePaymentAdd target = (ReceivePaymentAdd) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _receivePaymentAddChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.ReceivePaymentAddChoice.class, "_receivePaymentAddChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ReceivePaymentAdd target = (ReceivePaymentAdd) object;
                return target.getReceivePaymentAddChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ReceivePaymentAdd target = (ReceivePaymentAdd) object;
                    target.setReceivePaymentAddChoice( (org.chocolate_milk.model.ReceivePaymentAddChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.ReceivePaymentAddChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.ReceivePaymentAddChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.ReceivePaymentAddChoiceDescriptor());
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _receivePaymentAddChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.ReceivePaymentAdd.class;
    }
