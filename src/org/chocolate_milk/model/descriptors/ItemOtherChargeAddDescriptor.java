 ...
 * Schema.
 * $Id: ItemOtherChargeAddDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.ItemOtherChargeAdd;

/**
 * Class ItemOtherChargeAddDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class ItemOtherChargeAddDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ItemOtherChargeAddDescriptor() {
        super();
        _xmlName = "ItemOtherChargeAdd";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ItemOtherChargeAdd target = (ItemOtherChargeAdd) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _itemOtherChargeAddChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.ItemOtherChargeAddChoice.class, "_itemOtherChargeAddChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ItemOtherChargeAdd target = (ItemOtherChargeAdd) object;
                return target.getItemOtherChargeAddChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ItemOtherChargeAdd target = (ItemOtherChargeAdd) object;
                    target.setItemOtherChargeAddChoice( (org.chocolate_milk.model.ItemOtherChargeAddChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.ItemOtherChargeAddChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.ItemOtherChargeAddChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.ItemOtherChargeAddChoiceDescriptor());
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _itemOtherChargeAddChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.ItemOtherChargeAdd.class;
    }
