 ...
 * Schema.
 * $Id: SalesOrderAddDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.SalesOrderAdd;

/**
 * Class SalesOrderAddDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class SalesOrderAddDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SalesOrderAddDescriptor() {
        super();
        _xmlName = "SalesOrderAdd";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                SalesOrderAdd target = (SalesOrderAdd) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _salesOrderAddChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.SalesOrderAddChoice.class, "_salesOrderAddChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                SalesOrderAdd target = (SalesOrderAdd) object;
                return target.getSalesOrderAddChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SalesOrderAdd target = (SalesOrderAdd) object;
                    target.setSalesOrderAddChoice( (org.chocolate_milk.model.SalesOrderAddChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.SalesOrderAddChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.SalesOrderAddChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.SalesOrderAddChoiceDescriptor());
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _salesOrderAddChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.SalesOrderAdd.class;
    }
