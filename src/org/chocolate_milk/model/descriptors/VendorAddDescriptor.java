 ...
 * Schema.
 * $Id: VendorAddDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.VendorAdd;

/**
 * Class VendorAddDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class VendorAddDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public VendorAddDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                VendorAdd target = (VendorAdd) object;
        ...
        desc.setImmutable(true);
        desc.setSchemaType("ReportingPeriodType");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.VendorAdd.class;
    }
