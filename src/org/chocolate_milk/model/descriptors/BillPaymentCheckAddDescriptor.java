 ...
 * Schema.
 * $Id: BillPaymentCheckAddDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.BillPaymentCheckAdd;

/**
 * Class BillPaymentCheckAddDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class BillPaymentCheckAddDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public BillPaymentCheckAddDescriptor() {
        super();
        _xmlName = "BillPaymentCheckAdd";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                BillPaymentCheckAdd target = (BillPaymentCheckAdd) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _billPaymentCheckAddChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.BillPaymentCheckAddChoice.class, "_billPaymentCheckAddChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                BillPaymentCheckAdd target = (BillPaymentCheckAdd) object;
                return target.getBillPaymentCheckAddChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    BillPaymentCheckAdd target = (BillPaymentCheckAdd) object;
                    target.setBillPaymentCheckAddChoice( (org.chocolate_milk.model.BillPaymentCheckAddChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.BillPaymentCheckAddChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.BillPaymentCheckAddChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.BillPaymentCheckAddChoiceDescriptor());
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _billPaymentCheckAddChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
        ...
        desc.setValidator(fieldValidator);
        //-- _appliedToTxnAddList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.AppliedToTxnAdd.class, "_appliedToTxnAddList", "AppliedToTxnAdd", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                BillPaymentCheckAdd target = (BillPaymentCheckAdd) object;
                return target.getAppliedToTxnAdd();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    BillPaymentCheckAdd target = (BillPaymentCheckAdd) object;
                    target.addAppliedToTxnAdd( (org.chocolate_milk.model.AppliedToTxnAdd) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            public void resetValue(Object object) throws IllegalStateException, IllegalArgumentException {
                try {
                    BillPaymentCheckAdd target = (BillPaymentCheckAdd) object;
                    target.removeAllAppliedToTxnAdd();
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setComponentType("org.chocolate_milk.model.AppliedToTxnAdd");
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        //-- validation code for: _appliedToTxnAddList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.BillPaymentCheckAdd.class;
    }
