 ...
 * Schema.
 * $Id: ARRefundCreditCardRetDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.ARRefundCreditCardRet;

/**
 * Class ARRefundCreditCardRetDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class ARRefundCreditCardRetDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ARRefundCreditCardRetDescriptor() {
        super();
        _xmlName = "ARRefundCreditCardRet";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ARRefundCreditCardRet target = (ARRefundCreditCardRet) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _refundFromAccountRef
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.RefundFromAccountRef.class, "_refundFromAccountRef", "RefundFromAccountRef", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ARRefundCreditCardRet target = (ARRefundCreditCardRet) object;
                return target.getRefundFromAccountRef();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ARRefundCreditCardRet target = (ARRefundCreditCardRet) object;
                    target.setRefundFromAccountRef( (org.chocolate_milk.model.RefundFromAccountRef) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setSchemaType("org.chocolate_milk.model.RefundFromAccountRef");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _refundFromAccountRef
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
        ...
        desc.setValidator(fieldValidator);
        //-- _refundAppliedToTxnRetList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.RefundAppliedToTxnRet.class, "_refundAppliedToTxnRetList", "RefundAppliedToTxnRet", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ARRefundCreditCardRet target = (ARRefundCreditCardRet) object;
                return target.getRefundAppliedToTxnRet();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ARRefundCreditCardRet target = (ARRefundCreditCardRet) object;
                    target.addRefundAppliedToTxnRet( (org.chocolate_milk.model.RefundAppliedToTxnRet) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            public void resetValue(Object object) throws IllegalStateException, IllegalArgumentException {
                try {
                    ARRefundCreditCardRet target = (ARRefundCreditCardRet) object;
                    target.removeAllRefundAppliedToTxnRet();
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setComponentType("org.chocolate_milk.model.RefundAppliedToTxnRet");
        desc.setHandler(handler);
        desc.setMultivalued(true);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _refundAppliedToTxnRetList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.ARRefundCreditCardRet.class;
    }
