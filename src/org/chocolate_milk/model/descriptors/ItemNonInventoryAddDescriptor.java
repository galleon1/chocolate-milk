 ...
 * Schema.
 * $Id: ItemNonInventoryAddDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.ItemNonInventoryAdd;

/**
 * Class ItemNonInventoryAddDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class ItemNonInventoryAddDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ItemNonInventoryAddDescriptor() {
        super();
        _xmlName = "ItemNonInventoryAdd";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ItemNonInventoryAdd target = (ItemNonInventoryAdd) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _itemNonInventoryAddChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.ItemNonInventoryAddChoice.class, "_itemNonInventoryAddChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ItemNonInventoryAdd target = (ItemNonInventoryAdd) object;
                return target.getItemNonInventoryAddChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ItemNonInventoryAdd target = (ItemNonInventoryAdd) object;
                    target.setItemNonInventoryAddChoice( (org.chocolate_milk.model.ItemNonInventoryAddChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.ItemNonInventoryAddChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.ItemNonInventoryAddChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.ItemNonInventoryAddChoiceDescriptor());
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _itemNonInventoryAddChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.ItemNonInventoryAdd.class;
    }
