 ...
 * Schema.
 * $Id: BillingRateFilterDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.BillingRateFilter;

/**
 * Class BillingRateFilterDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class BillingRateFilterDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public BillingRateFilterDescriptor() {
        super();
        _xmlName = "BillingRateFilter";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                BillingRateFilter target = (BillingRateFilter) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _billingRateFilterChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.BillingRateFilterChoice.class, "_billingRateFilterChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                BillingRateFilter target = (BillingRateFilter) object;
                return target.getBillingRateFilterChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    BillingRateFilter target = (BillingRateFilter) object;
                    target.setBillingRateFilterChoice( (org.chocolate_milk.model.BillingRateFilterChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.BillingRateFilterChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.BillingRateFilterChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.BillingRateFilterChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _billingRateFilterChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.BillingRateFilter.class;
    }
