 ...
 * Schema.
 * $Id: DepositAddDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.DepositAdd;

/**
 * Class DepositAddDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class DepositAddDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DepositAddDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                DepositAdd target = (DepositAdd) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _cashBackInfoAdd
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.CashBackInfoAdd.class, "_cashBackInfoAdd", "CashBackInfoAdd", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                DepositAdd target = (DepositAdd) object;
                return target.getCashBackInfoAdd();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    DepositAdd target = (DepositAdd) object;
                    target.setCashBackInfoAdd( (org.chocolate_milk.model.CashBackInfoAdd) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setSchemaType("org.chocolate_milk.model.CashBackInfoAdd");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _cashBackInfoAdd
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
        ...
        desc.setValidator(fieldValidator);
        //-- _depositLineAddList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.DepositLineAdd.class, "_depositLineAddList", "DepositLineAdd", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                DepositAdd target = (DepositAdd) object;
                return target.getDepositLineAdd();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    DepositAdd target = (DepositAdd) object;
                    target.addDepositLineAdd( (org.chocolate_milk.model.DepositLineAdd) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            public void resetValue(Object object) throws IllegalStateException, IllegalArgumentException {
                try {
                    DepositAdd target = (DepositAdd) object;
                    target.removeAllDepositLineAdd();
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setComponentType("org.chocolate_milk.model.DepositLineAdd");
        desc.setHandler(handler);
        desc.setMultivalued(true);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _depositLineAddList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.DepositAdd.class;
    }
