 ...
 * Schema.
 * $Id: BillPaymentCreditCardAddDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.BillPaymentCreditCardAdd;

/**
 * Class BillPaymentCreditCardAddDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class BillPaymentCreditCardAddDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public BillPaymentCreditCardAddDescriptor() {
        super();
        _xmlName = "BillPaymentCreditCardAdd";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                BillPaymentCreditCardAdd target = (BillPaymentCreditCardAdd) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _creditCardAccountRef
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.CreditCardAccountRef.class, "_creditCardAccountRef", "CreditCardAccountRef", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                BillPaymentCreditCardAdd target = (BillPaymentCreditCardAdd) object;
                return target.getCreditCardAccountRef();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    BillPaymentCreditCardAdd target = (BillPaymentCreditCardAdd) object;
                    target.setCreditCardAccountRef( (org.chocolate_milk.model.CreditCardAccountRef) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setSchemaType("org.chocolate_milk.model.CreditCardAccountRef");
        desc.setHandler(handler);
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        //-- validation code for: _creditCardAccountRef
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.BillPaymentCreditCardAdd.class;
    }
