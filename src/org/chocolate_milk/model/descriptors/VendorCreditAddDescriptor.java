 ...
 * Schema.
 * $Id: VendorCreditAddDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.VendorCreditAdd;

/**
 * Class VendorCreditAddDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class VendorCreditAddDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public VendorCreditAddDescriptor() {
        super();
        _xmlName = "VendorCreditAdd";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                VendorCreditAdd target = (VendorCreditAdd) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _vendorCreditAddChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.VendorCreditAddChoice.class, "_vendorCreditAddChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                VendorCreditAdd target = (VendorCreditAdd) object;
                return target.getVendorCreditAddChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    VendorCreditAdd target = (VendorCreditAdd) object;
                    target.setVendorCreditAddChoice( (org.chocolate_milk.model.VendorCreditAddChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.VendorCreditAddChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.VendorCreditAddChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.VendorCreditAddChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _vendorCreditAddChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.VendorCreditAdd.class;
    }
