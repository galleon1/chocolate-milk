 ...
 * Schema.
 * $Id: PurchaseOrderLineGroupModDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.PurchaseOrderLineGroupMod;

/**
 * Class PurchaseOrderLineGroupModDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class PurchaseOrderLineGroupModDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PurchaseOrderLineGroupModDescriptor() {
        super();
        _xmlName = "PurchaseOrderLineGroupMod";
        ...
        //-- _txnLineID
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.PurchaseOrderLineGroupModTxnLineID.class, "_txnLineID", "TxnLineID", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                PurchaseOrderLineGroupMod target = (PurchaseOrderLineGroupMod) object;
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PurchaseOrderLineGroupMod target = (PurchaseOrderLineGroupMod) object;
                    target.setTxnLineID( (org.chocolate_milk.model.PurchaseOrderLineGroupModTxnLineID) value);
        ...
        desc.setSchemaType("org.chocolate_milk.model.PurchaseOrderLineGroupModTxnLineID");
        ...
        desc.setValidator(fieldValidator);
        //-- _purchaseOrderLineModList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.PurchaseOrderLineMod.class, "_purchaseOrderLineModList", "PurchaseOrderLineMod", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PurchaseOrderLineGroupMod target = (PurchaseOrderLineGroupMod) object;
                    target.addPurchaseOrderLineMod( (org.chocolate_milk.model.PurchaseOrderLineMod) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            public void resetValue(Object object) throws IllegalStateException, IllegalArgumentException {
                try {
                    PurchaseOrderLineGroupMod target = (PurchaseOrderLineGroupMod) object;
                    target.removeAllPurchaseOrderLineMod();
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setComponentType("org.chocolate_milk.model.PurchaseOrderLineMod");
        desc.setHandler(handler);
        desc.setMultivalued(true);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _purchaseOrderLineModList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.PurchaseOrderLineGroupMod.class;
    }
