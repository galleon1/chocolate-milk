 ...
 * Schema.
 * $Id: CreditMemoAddDescriptor.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
import org.chocolate_milk.model.CreditMemoAdd;

/**
 * Class CreditMemoAddDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:00 $
 */
public class CreditMemoAddDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CreditMemoAddDescriptor() {
        super();
        _xmlName = "CreditMemoAdd";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CreditMemoAdd target = (CreditMemoAdd) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _creditMemoAddChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.CreditMemoAddChoice.class, "_creditMemoAddChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                CreditMemoAdd target = (CreditMemoAdd) object;
                return target.getCreditMemoAddChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    CreditMemoAdd target = (CreditMemoAdd) object;
                    target.setCreditMemoAddChoice( (org.chocolate_milk.model.CreditMemoAddChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.CreditMemoAddChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.CreditMemoAddChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.CreditMemoAddChoiceDescriptor());
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _creditMemoAddChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.CreditMemoAdd.class;
    }
