 ...
 * Schema.
 * $Id: CreditCardChargeAddDescriptor.java,v 1.1.1.1 2010-05-04 22:06:00 ryan Exp $
 */
...
import org.chocolate_milk.model.CreditCardChargeAdd;

/**
 * Class CreditCardChargeAddDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:00 $
 */
public class CreditCardChargeAddDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CreditCardChargeAddDescriptor() {
        super();
        _xmlName = "CreditCardChargeAdd";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CreditCardChargeAdd target = (CreditCardChargeAdd) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _creditCardChargeAddChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.CreditCardChargeAddChoice.class, "_creditCardChargeAddChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                CreditCardChargeAdd target = (CreditCardChargeAdd) object;
                return target.getCreditCardChargeAddChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    CreditCardChargeAdd target = (CreditCardChargeAdd) object;
                    target.setCreditCardChargeAddChoice( (org.chocolate_milk.model.CreditCardChargeAddChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.CreditCardChargeAddChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.CreditCardChargeAddChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.CreditCardChargeAddChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _creditCardChargeAddChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.CreditCardChargeAdd.class;
    }
