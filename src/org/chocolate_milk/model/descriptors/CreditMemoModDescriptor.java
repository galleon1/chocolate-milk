 ...
 * Schema.
 * $Id: CreditMemoModDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.CreditMemoMod;

/**
 * Class CreditMemoModDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class CreditMemoModDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CreditMemoModDescriptor() {
        super();
        _xmlName = "CreditMemoMod";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CreditMemoMod target = (CreditMemoMod) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _creditMemoModChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.CreditMemoModChoice.class, "_creditMemoModChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                CreditMemoMod target = (CreditMemoMod) object;
                return target.getCreditMemoModChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    CreditMemoMod target = (CreditMemoMod) object;
                    target.setCreditMemoModChoice( (org.chocolate_milk.model.CreditMemoModChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.CreditMemoModChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.CreditMemoModChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.CreditMemoModChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _creditMemoModChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.CreditMemoMod.class;
    }
