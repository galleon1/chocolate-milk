 ...
 * Schema.
 * $Id: CreditCardCreditAddDescriptor.java,v 1.1.1.1 2010-05-04 22:06:01 ryan Exp $
 */
...
import org.chocolate_milk.model.CreditCardCreditAdd;

/**
 * Class CreditCardCreditAddDescriptor.
 * 
 * @version $Revision: 1.1.1.1 $ $Date: 2010-05-04 22:06:01 $
 */
public class CreditCardCreditAddDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CreditCardCreditAddDescriptor() {
        super();
        _xmlName = "CreditCardCreditAdd";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CreditCardCreditAdd target = (CreditCardCreditAdd) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _creditCardCreditAddChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.chocolate_milk.model.CreditCardCreditAddChoice.class, "_creditCardCreditAddChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                CreditCardCreditAdd target = (CreditCardCreditAdd) object;
                return target.getCreditCardCreditAddChoice();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    CreditCardCreditAdd target = (CreditCardCreditAdd) object;
                    target.setCreditCardCreditAddChoice( (org.chocolate_milk.model.CreditCardCreditAddChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.chocolate_milk.model.CreditCardCreditAddChoice();
            }
        };
        desc.setSchemaType("org.chocolate_milk.model.CreditCardCreditAddChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.chocolate_milk.model.descriptors.CreditCardCreditAddChoiceDescriptor());
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _creditCardCreditAddChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.chocolate_milk.model.CreditCardCreditAdd.class;
    }
